...
const ConsratsPage = () => {
  ...
  return (
    <>
      ...
      >
        <Box boxShadow="base" p="1rem" width="92%" h="160px" bg="white">
          <Flex gap="20px">
            {" "}
            <Image
            ...
            />
            <Box>
              <Text color="black" fontSize="20px" fontWeight="450">
                Why call ? just click!
              </Text>
              <Text>Easily tracks all your flipkart orders</Text>
              <NavLink to="/orderpage">
                <Button mt="12px" borderRadius="4px" color="white" bg="#2874f0">
                  Go to my orders
                </Button>
              </NavLink>
            </Box>
        ...
        >
          <Flex>
            <Grid fontWeight="400" color="black" gap="7px" p="20px">
              <GridItem>Delivery Address</GridItem>

              <GridItem fontSize="15px">
                {" "}
                <Text>{globalAddress.Name} </Text>
              </GridItem>
        ...
        <Box width="92%" h="140px" bg="white">
          <Flex mt="4px" justifyContent="center" alignItems="center" gap="8px">
            ...
            <Text color="#2874ee" marginRight="3px" fontSize="4xl">
              AGAIN
            </Text>
            <Image
              height="50px"
      ...
      <Box display={["block", "none", "none"]}>
        <Box>
          ...
          <Box display={"block"}>
            ...
            <Text textAlign="center">Thank you for shopping with us</Text>
            <Flex w="40%" margin={"auto"}>
              <Text textAlign="center">Have a nice day </Text>
