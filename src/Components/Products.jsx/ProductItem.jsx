  ...
  return (
    <NavLink to={`/products/view/${property.item_id}`}>
      <Box
        key={i}
        className="my-box"
        border={!isLargerThan720 ? "0.1px solid #B0B0B0" : ""}
      >
        <Box
          overflow="hidden"
        ...
        >
          ...
          >
            ...
            <Box
              ...
              top={"12px"}
              right={isLargerThan720 ? "12px" : "5px"}
              cursor="pointer"
            >
              <Box
                pos={"relative"}
          ...
          >
            ...
            >
              ...
              <Flex gap={3} mt={1} alignItems="center" cursor="pointer">
                <Text color={"#212121"} fontWeight={"600"} fontSize="16px">
                  ₹{property.new_price}
                </Text>
                <Text textDecoration="line-through">₹{property.old_price}</Text>
                <Text color={"#388e3c"} fontWeight="bold" fontSize={"13px"}>
                  {property.discount}%off
                </Text>
              </Flex>
              <Flex mt={3} alignItems="center" gap={2}>
                <Text color={"#878787"} fontWeight={"600"} fontSize="14px">
                  Size
                </Text>
