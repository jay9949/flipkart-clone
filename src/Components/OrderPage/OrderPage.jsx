          ...
          <Box display="flex" gap="15px" bg="#F1F3F6" pt="2.5rem">
            ...
            >
              <Breadcrumb
                ...
                color={"#878787"}
                fontWeight={"600"}
                fontSize={{ base: "0px", md: "10px", lg: "13px" }}
                pl="1.5rem"
                bg="#F1F3F6"
                spacing="2px"
              ...
              <Text pl="50px" fontSize={"22px"}>
                {" "}
                Filters
              </Text>
              <hr />
              <Box p="5px 0px 13px 50px">
            ...
            <Box width={{ base: "100%", md: "100%", lg: "80%" }}>
              ...
              >
                ...
                >
                  {" "}
                  <FaSearch size={"16px"} color="#838383" />{" "}
                  <Input
                    className="out"
                    style={{ outline: "none", padding: "7px" }}
                    w={{ base: "260px", md: "500px", lg: "15px" }}
                ...
                <Box ml="20px" mr="20px" onClick={onOpen}>
                  {" "}
                  <IoFilterOutline color="black" size="25px" />
                </Box>{" "}
              ...
              >
                {Order.map((item) => (
                  <Flex
                    fontSize={{ base: "8.5px", md: "15px", lg: "18px" }}
                    h="110px"
                  ...
                  >
                    ...
                    <Box>
                      {" "}
                      <Text fontWeight={"400"} w="300px" fontSize="16px">
                        {" "}
                        {item.description}
                      </Text>
                    </Box>
                    ...
                    <Text display="flex" fontSize={"14px"} alignItems="center">
                      {" "}
                      <BiRadioCircle color="green" size="16px" /> Delivery
                ...
                {Order.map((item) => (
                  ...
                  >
                    ...
                    <Box>
                      ...
                      >
                        {" "}
                        Delivery Expected By {FormatDate()}
                      </Text>
                      <Text
                        pt="15px"
                        w="220px"
