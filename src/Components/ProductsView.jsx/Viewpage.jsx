...
const Viewpage = () => {
  ...
  console.log(SetCartData, carturl);
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(
        `https://flipkart-data-h5tg.onrender.com/all?item_id=${item_id}`
      );
      ...
      <HStack p="10px" display={{ base: "block", md: "flex", lg: "flex" }}>
            ...
            <Box display={"flex"} p="15px">
              <Box w="15%">
                <Box
                  ...
                  p="7px"
                  border={"2px solid #2974F1"}
                  m="auto"
                >
                  <Img
                    w={{ base: "0px", md: "30px", lg: "45px" }}
                    m="auto"
                    src={item.image}
                    alt="smallImg"
                  />
              ...
              >
                <Img
                  maxH={{ base: "500px", md: "300px", lg: "100%" }}
                  mw="450px"
                  m="auto"
                  src={item.image}
                />
              ...
              >
                {" "}
                <FaHeart color="silver" size="25px" />{" "}
              </Box>
            </Box>
            <Flex
              pt="30px"
        ...
        {viewData.map((item, index) => (
          <Box
            ...
            pt="-50px"
            h="100vh"
            overflow={{ base: "none", md: "auto", lg: "auto" }}
            pl="2%"
            className="example"
          >
            <Box display={{ base: "none", md: "block", lg: "block" }}>
              {" "}
              <Text p="15px" display="flex" alignItems="center" float="right">
                {" "}
                <IoMdShareAlt /> Share
              </Text>
            </Box>
            <Box>
              {" "}
              <Text color={"silver"}> {item.brand} </Text>
            </Box>
            ...
            >
              ...
              <Img
                w="18px"
                mr="5px"
                src="https://rukminim1.flixcart.com/www/36/36/promos/30/07/2019/79f48e86-8a93-46ab-b45a-5a12df491941.png?q=90"
                alt="small"
              />{" "}
              Special Price₹100 off with cashback coupon on First Order{" "}
              <Text color={"#2974F1"} pl="5px">
                T&C{" "}
              </Text>
            </Box>
            ...
            >
              ...
              <Img
                ...
                alt="small copoun"
              />
              Special PriceGet extra 22% off (price inclusive of
              cashback/coupon){" "}
              <Text color={"#2974F1"} pl="5px">
                {" "}
                T&C
            ...
            >
              ...
              <Img
                ...
                alt="small copoun"
              />{" "}
              Bank OfferTest - 10% off on HDFC Bank Cardless EMI, up to ₹500. On
              orders of ₹3000 and above
            </Box>
            <br />
            <br />
            <Flex
            ...
            >
              ...
              <Box>
                <Text display={"flex"} mb="15px" alignItems="center">
                  {" "}
                  <MdRestartAlt size="15px" color="#2974F1" /> 10 Days Return
                  Policy
                </Text>
                <Text display={"flex"} alignItems="center">
                  {" "}
                  <HiCurrencyRupee size="15px" color="#2974F1" /> Cash on
                  Delivery available
                </Text>
              </Box>
            </Flex>
            <Box pt="20px" fontSize={"12px"}>
              {" "}
              <Text> Usually delivered in8 days</Text>
            ...
            <Img
              w={{ base: "200px", md: "280px", lg: "400px" }}
              p="20px"
            ...
            >
              <AccordionItem bg="white">
                <h1>
                  <AccordionButton
                    bg="white"
                    pt={{ base: "15px", md: "20px", lg: "25px" }}
                    pb={{ base: "15px", md: "20px", lg: "25px" }}
                  >
            ...
            >
              ...
              <Box>
                <Button
                  ...
                  color={"white"}
                  pos=""
                  fontSize={{ base: "8px", md: "11px", lg: "15px" }}
                  h={{ base: "18px", md: "30px", lg: "40px" }}
                  _hover={{ bg: "#2974F1" }}
                >
                  Rate Product
                </Button>
